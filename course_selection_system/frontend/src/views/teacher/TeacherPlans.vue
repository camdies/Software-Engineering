<template>
  <div class="page-card">
    ...
    <!-- 新增/编辑对话框 -->
    <el-dialog v-model="dialogVisible" :title="editing ? '修改申请' : '新增授课申请'" width="560px">
      <el-form ref="formRef" :model="form" label-width="100px">
        <el-form-item label="课程" required>
          <el-select v-model="form.course_id" filterable placeholder="搜索课程代码" style="width:100%" :disabled="!!editing"
        ...
        <el-row :gutter="12">
          ...
          <el-col :span="8">
            <el-form-item label="起始节" required><el-select v-model="form.period_start" style="width:100%">
              <el-option v-for="p in 11" :key="p" :label="`第${p}节`" :value="p" /></el-select></el-form-item>
          </el-col>
          <el-col :span="8">
        ...
        <el-row :gutter="12">
          <el-col :span="12">
            <el-form-item label="起始周" required><el-input-number v-model="form.start_week" :min="1" :max="20" style="width:100%" /></el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="结束周" required><el-input-number v-model="form.end_week" :min="1" :max="20" style="width:100%" /></el-form-item>
          </el-col>
        </el-row>
...
const form = reactive({
  ...
  start_week: 1, end_week: 20, location: '', capacity: 30, prerequisite: '',
})
